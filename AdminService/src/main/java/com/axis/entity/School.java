...
public class School {
	...
	public School(Long school_id, double totalMoneyEarned, double totalMoneySpent, String schoolName, String schoolAddr,
			double totalFunds) {
		super();
	...
	public String toString() {
		return "School [school_id=" + school_id + ", totalMoneyEarned=" + totalMoneyEarned + ", totalMoneySpent="
				+ totalMoneySpent + ", schoolName=" + schoolName + ", schoolAddr=" + schoolAddr + ", totalFunds="
				+ totalFunds + "]";
	}
